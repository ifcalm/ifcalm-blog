---
title: "第 24 讲：多路访问协议、以太网与交换机"
date: 2026-08-27
weight: 24
tags: ["计算机网络"]
draft: false
summary: "共享一条信道的三类办法与它们的效率极限、以太网的帧格式与最小帧长之谜、ARP 如何在同一子网和跨子网时表现不同、交换机的自学习算法，以及交换机与路由器的完整对比。"
showToc: true
tocOpen: false
---

> 📖 **课前阅读**：KR 第 8 版 §6.3–§6.6
> ⏱ **课时**：75 分钟 · 🧪 **配套**：Lab 1 Part E · ⚠️ **期末考试重点**
...
1. **分类**多路访问协议，并**推导**时隙 ALOHA 的效率极限。
2. **描述** CSMA/CD 的完整流程与二进制指数退避。
3. **解释**以太网**最小帧长 64 字节**的由来。
4. **追踪** ARP 在同一子网与跨子网两种情形下的完整过程。
5. **执行**交换机的自学习算法。
6. **对比**交换机与路由器的六个维度。
...
*上一篇：[第 23 讲：链路层服务与差错检测]({{< ref "23-link-layer-error-detection.md" >}})*
*下一篇：[第 25 讲：无线链路与 802.11 WiFi]({{< ref "25-wireless-wifi.md" >}})*
