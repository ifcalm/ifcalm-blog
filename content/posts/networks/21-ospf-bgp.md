...
> 📖 **课前阅读**：KR 第 8 版 §5.3–§5.4；RFC 4271（BGP-4）
> ⏱ **课时**：75 分钟 · 📝 **配套**：PS 3 第 20–23 题
...
1. **论证**路由为什么必须分层（两个理由）。
2. **描述** OSPF 的区域结构及其解决的问题。
3. **区分** eBGP 与 iBGP 会话。
4. **解释** AS_PATH 与 NEXT_HOP 属性的作用。
5. **按优先级顺序**执行 BGP 的路由选择算法。
6. **说明**热土豆路由与 Gao-Rexford 策略规则。
7. **分析** BGP 劫持的原理与 RPKI 的防御范围。
...
*上一篇：[第 20 讲：路由算法——链路状态与距离向量]({{< ref "20-routing-algorithms.md" >}})*
*下一篇：[第 22 讲：SDN 控制平面、ICMP 与网络管理]({{< ref "22-sdn-icmp-management.md" >}})*
