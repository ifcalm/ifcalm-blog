---
title: "第 20 讲：EVM 的结构——一台 256 位栈机"
date: 2026-08-30
weight: 20
tags: ["区块链"]
draft: false
...
⭐ **一句话：EVM 是为"链上执行便宜"设计的，而不是为"被证明"设计的。** 这就是为什么 zkEVM 项目要么接受巨大的证明开销，要么放弃字节码级等价（第 27 讲会讲这几个层次）。
...
3. 一个合约把一个 `uint8` 存进 storage，实际占多少字节？为什么？（第 22 讲会给出优化办法）
