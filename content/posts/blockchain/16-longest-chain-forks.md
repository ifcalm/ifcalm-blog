...
**你**打开钱包，看到一笔转账"已确认 1 个区块"。十分钟后再看，它不见了。
...
现在没有裁判，没有投票，也没有人有权宣布哪个算数。这一讲讲的就是：在这种情况下，一群互不信任的人**靠一条谁都能独立算出的规则**，最终收敛到同一条链上。
...
"最长链"和"最重的链"的差别，像**比较两摞纸**。

"最长"是比**页数**——而页数是可以灌水的：把难度调低，就能快速印出一大摞薄纸。

"最重"是比**总重量**——每一页有多重，由它对应的难度决定。攻击者印再多张，那摞纸也轻。
...
⭐ 用那两摞纸来说：51% 攻击的意思是**攻击者有能力持续造出更重的那一摞**。注意它买到的只是"重量"——下面这一节说明，重量能改写顺序，但改不了那些需要签名才能做的事。
