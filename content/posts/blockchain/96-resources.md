...
| 文献 | 说明 |
|---|---|
| Lamport, Shostak, Pease, *The Byzantine Generals Problem* (1982) | ⭐ `n ≥ 3f+1` 的来源。⚠️ 论文本身不难，但要耐心读那个不可区分性论证 |
| Fischer, Lynch, Paterson, *Impossibility of Distributed Consensus with One Faulty Process* (1985) | ⭐ FLP。⚠️ 证明较技术化，第一次读可只看结论与直觉 |
...
③ 具体协议的实现细节
   ⚠️ Uniswap、Aave、Compound 等的具体机制变化很快。
