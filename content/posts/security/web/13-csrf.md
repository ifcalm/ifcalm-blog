...
说得更直白一点：cookie 像一张**门禁卡**，而浏览器是个特别热心的助理：只要你去银行的门，它就自动替你刷卡——**不管是你自己走过去的，还是被人骗过去的。**
...
⭐ 回到那个比方：cookie 是门禁卡，浏览器那个热心助理会自动替你刷。**CSRF 令牌的作用，是在刷卡之外再要一句只有本人知道的暗号**——助理不知道暗号，所以他再热心也带不进去。

而攻击者拿不到暗号，恰恰是因为同源策略挡住了他读你页面的内容。
