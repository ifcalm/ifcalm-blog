...
前六篇讲的是机制和数学：确定的、可查证的、不会过期的东西。它们决定你**能不能留在牌桌上**，但它们本身不产生任何收益。这一篇处理另一半问题：**收益从哪里来。**
...
不计佣金、价差、滑点、资金费、借券费和税的回测，在高频次策略上可以把一个亏损策略显示成盈利策略。**交易越频繁，失真越大。** 参考第八篇：单次 0.2% 成本、每日一次往返，年成本约 40%（线性相加是 50%）。
