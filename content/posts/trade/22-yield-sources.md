...
[第十篇](/posts/trade/10-market-neutral/)处理过一类「稳定年化」——做市和基差套利。这一篇处理另一大类：**质押、借贷、流动性挖矿、收益型稳定币**。

它们的共同点是给你一个 APY 数字。而这个数字本身**不含任何信息**，因为它没告诉你最关键的事：
...
*上一篇：[代币经济学——供应、解锁与稀释]({{< ref "21-tokenomics.md" >}})*
*下一篇：[尽调——合约权限、储备证明与平台选择]({{< ref "23-due-diligence.md" >}})*
