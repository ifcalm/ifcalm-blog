...
误解主要有两个方向：买方以为它是「小博大」的便宜彩票，卖方以为它是「收租」的稳定现金流。**两个理解都漏掉了各自最重要的那一项风险。**
...
希腊字母不是「指标」，它们是期权价格对各个变量的**偏导数**——即「某个东西变动一单位，期权价格变动多少」。
...
*上一篇：[不依赖方向的策略——做市与基差套利]({{< ref "10-market-neutral.md" >}})*
*下一篇：[杠杆 ETF、产品结构与公司行为]({{< ref "12-product-structures.md" >}})*
