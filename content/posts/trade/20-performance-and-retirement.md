...
> ⭐ **「执行偏差」这一项可以被进一步拆开**：给每笔打「计划内 / 计划外」标签再分组统计，**两组期望值之差就是你的执行质量值多少钱**——[第 46 篇]({{< ref "46-behavioral-edge.md" >}})第八节。⚠️ 这条信息在合并统计时完全看不见。
...
*下一篇：[代币经济学——供应、解锁与稀释]({{< ref "21-tokenomics.md" >}})*
