...
理由很直接：**入场决定你能不能赚钱，仓位决定你能不能活着。** 而在一个负和的、高不确定性的环境里，活着是赚钱的前提条件。
...
*上一篇：[订单类型与执行质量]({{< ref "05-order-types.md" >}})*
*下一篇：[优势从哪里来——分析方法、市场异象与检验]({{< ref "07-analysis-methods.md" >}})*
