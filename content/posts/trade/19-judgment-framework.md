...
- ⚠️ **市场可能提前定价** —— 这恰恰是要测的东西，不能假设

#### 5. 资金费率极端值

- **主张**：极端拥挤的杠杆状态之后，波动特征会改变
- ⚠️ **测波动率，不要测方向**。「极高正费率 → 之后一定跌」是方向主张，很难成立；「极高正费率 → 之后一段时间的下行波动率显著上升」是波动率主张，机制上更站得住（连环强平，第四篇）
- **这个区别很关键**：把假设降级到波动率层面，它更可能是真的，而且它直接服务于仓位管理

#### 6. 基差 / 资金费率套利（第十篇）

- **收益来源最清楚**：杠杆做多需求的结构性过剩
- ⚠️ 价格风险被换成了**对手方风险**；实际到手年化远低于名义（保证金缓冲的成本）
...
*上一篇：[执行层——从决策到成交]({{< ref "18-execution.md" >}})*
*下一篇：[绩效度量、策略退役与资金管理]({{< ref "20-performance-and-retirement.md" >}})*
