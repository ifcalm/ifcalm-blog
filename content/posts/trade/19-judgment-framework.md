...
这一步是纯算术，而且经常直接否决掉整个交易风格。单次往返 0.2%、每日 3 次，一年 750 次往返，光成本就吃掉本金的四分之三以上（复利 −78%；线性相加是 150%）——**起跑线在负七成以上**。
...
⚠️ 最常见的误用，是把它当成"选餐厅"用——拿它去找**最好的**那笔交易。它做不到，也不是为此设计的。**它只负责排掉会让你进医院的那几家。**
