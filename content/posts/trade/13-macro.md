...
「为什么美联储一加息，成长股和加密货币会一起跌？」这是一个**机制问题**，不是预测问题——所以它符合这份手册的准入标准（回顾第七篇的分类）。理解它不需要预测未来，而理解之后，第六篇讲的「相关性在危机中趋向 1」会从一句结论变成一个可以推导的结果。
...
把利率想成**一段路程的"损耗率"**：钱从未来运到今天，每走一年都要被扣掉一点。
