...
⚠️ **在链上，「有人买入」不能证明「可以卖出」。** 这是 [第十五篇](/posts/trade/15-orderflow-data/)那句「成交数据只能测量已发生的事」的一个极端形式。
...
- ⚠️ **持有者排行榜不能直接读**：交易所钱包、LP 池、桥合约、归属合约会混在顶部。反过来，一个人可以拆成 100 个地址。
...
*上一篇：[收益从哪里来——质押、LST、再质押与 DeFi 收益]({{< ref "22-yield-sources.md" >}})*
*下一篇：[链上执行——Gas、抢跑防护与 L2 风险]({{< ref "24-onchain-execution.md" >}})*
