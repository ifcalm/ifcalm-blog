...
手册分成四部分：**第 1–9 篇是主体**，建议按顺序读；**第 10–20 篇是专题**，可以按需要挑着看；**第 21–25 篇是加密资产层**，回答「我买的这个东西到底是什么」；**第 26–43 篇是方法与实操**，其中只有第 29 篇是链上专属，其余几篇两个市场都适用。
...
⚠️ **第 42、43 篇严格说不属于「方法」**：前者是产品机制（第 12 篇的前置），后者是数据源（第 12 类）。放在这里只因为编号连续——**按性质它们更接近专题层和加密专题层。**
