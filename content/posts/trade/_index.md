...
layout: "list"
aliases: ["/posts/trade/00b-learning-path/"]
---
...
| **[练习索引]({{< ref "00d-exercises.md" >}})** | 按**需要什么才能做** | **哪些结论能自己动手验一遍** |
...
> **[Solana 实操]({{< ref "/posts/trade/sol" >}})**——每篇标注**最后核实时间**，读之前先看那个日期。机制部分仍然由主手册负责，那部分不会过期。
...
第 14 篇和交易技巧无关，但它防的是**不可逆**的损失——其他每一篇处理的都是可以再来一次的错误。
