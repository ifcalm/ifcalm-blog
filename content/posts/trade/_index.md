...
这份手册有**三个入口**，分别回答三个不同的问题：

| 入口 | 组织方式 | 回答 |
|---|---|---|
| 👉 **[学习路径]({{< ref "00b-learning-path.md" >}})** | 按**学习顺序** | ⭐ **先学什么、什么是前置、哪里可以停** |
| 👉 **[全流程索引]({{< ref "00-workflow-index.md" >}})** | 按**交易生命周期** | **什么时候用哪一篇** |
| 👉 **[术语与公式速查]({{< ref "00c-glossary.md" >}})** | 按**用途分组** | **这个词/公式是什么、在哪一篇** |
| 👉 **[练习索引]({{< ref "00d-exercises.md" >}})** | 按**需要什么才能做** | ⭐ **我能真的动手做点什么** |

下面的正文按**主题**组织。⚠️ **正文编号是写作顺序，不是学习顺序**——第一次读**建议从学习路径进入**；实际操作时用全流程索引；看到不认识的量回术语表查。

⭐ **而如果你只想先动手试点什么**：[练习索引]({{< ref "00d-exercises.md" >}})里 **E1、E4、E5、E23 四个加起来不到一小时，且不需要任何数据或代码**——它们能否决掉的东西，比读完全部正文还多。

## 结构

手册分成四部分：**第 1–9 篇是主体**，建议按顺序读；**第 10–20 篇是专题**，可以按需要挑着看；**第 21–25 篇是加密资产层**，回答「我买的这个东西到底是什么」；**第 26–47 篇是方法与实操**，其中只有第 29 篇是链上专属，其余几篇两个市场都适用。
